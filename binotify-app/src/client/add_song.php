...
<head>
    ...
    <link rel="stylesheet" href="client/css/add_song.css">
    <title>WBD - Add Song</title>
...
<body class="bg-gray" id>
    ...
    <div>
        <div class="col-12" id="main">
            <form id="addSongForm" method="POST" class="form-container m-5">
                <h2 class="text-white text-center">Add Song</h2>
                ...
                <label for="Album" class="text-white label-form">Album</label></br>
                <select name="album_id" id="album_id" class="input-dropdown">
                </select></br>
    ...
    <script type="module" src="client/app/add_song.js"></script>
    <?php echo_sidebar_js() ?>
</body>
</html>