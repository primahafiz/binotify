...
<head>
    ...
    <link rel="stylesheet" href="../client/css/edit_song.css">
    <title>WBD - Edit Song</title>
    <?php echo_sidebar_styles() ?>
</head>
<body class="bg-gray" id>
    <div>
        <?php
    ...
    <div>
        <div class="col-12" id="main">
            <form id="editSongForm" method="POST" class="form-container m-5">
                <h2 class="text-white text-center">Edit Song</h2>
                ...
                <label for="Genre" class="text-white label-form">Audio File</label></br>
                <input type="file" name="Music" id="Music"></br>
                <input type="checkbox" name="is_music_change" id="is_music_change" class="mt-5" value="1">
                <label for="is_music_change" class="label-checkbox">Keep using previous audio file</label></br>
                <label for="Genre" class="text-white label-form">Image File</label></br>
                <input type="file" name="Image_music" id="Image_music"></br>
    ...
    <script type="module" src="../client/app/edit_song.js"></script>
    <?php echo_sidebar_js() ?>
</body>
</html>